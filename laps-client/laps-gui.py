...
class LapsAboutWindow(QDialog):
	...
	def InitUI(self):
		...
		labelCopyright.setText(
			'<br>'
			'© 2024 <a href="https://github.com/kraloveckey">kraloveckey</a>'
			'<br>'
			'<br>'
			'MIT License'
			'<br>'
			...
			'<br>'
			'<br>'
			'If you like laps-client please consider<br>making a donation to support further development.'
			'<br>'
		)
		...
		labelDescription.setText(
			'laps-client allows you to query local administrator passwords for LAPS runner managed workstations in your domain from your LDAP (Active Directory) server.'
			'\n\n'
...
class LapsMainWindow(QMainWindow):
	...
	PRODUCT_NAME      = 'laps-client'
	PRODUCT_VERSION   = '1.0.0'
	PRODUCT_WEBSITE   = 'https://github.com/kraloveckey/mini-python/laps-client'
