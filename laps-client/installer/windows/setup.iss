...
#define MyAppName "laps-client"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "kraloveckey"
#define MyAppURL "https://github.com/kraloveckey/mini-python/laps-client"
...
OutputDir=.
OutputBaseFilename=laps-client
Compression=lzma
...
Root: HKCR; Subkey: "laps\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """C:\Program Files\laps-client\laps-gui.exe"" %1"

[Files]
Source: "..\..\dist\laps-client\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\dist\laps-client\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
