...
DMG_FILE_TMP_MOUNT="/Volumes/laps-client"
DMG_FILE_TMP="laps-client-rw.dmg"
DMG_FILE="laps-client.dmg"

# remove temp build folder
rm -r "../../dist/laps-client"
...
rm "../../dist/.DS_Store"
hdiutil create -srcfolder "../../dist" -volname "laps-client" -fs HFS+ -fsargs "-c c=64,a=16,e=16" -format UDRW "$DMG_FILE_TMP"
