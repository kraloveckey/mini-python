...
class LapsCli():
	...
	def __init__(self, useKerberos=None):
		...
		print('If you like laps-client please do not forget to give the repository a star ('+self.PRODUCT_WEBSITE+').')
...
def main():
	parser = argparse.ArgumentParser(epilog='© 2024 kraloveckey - https://github.com/kraloveckey')
